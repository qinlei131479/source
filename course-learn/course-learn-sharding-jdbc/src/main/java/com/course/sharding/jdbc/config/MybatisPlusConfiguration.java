package com.course.sharding.jdbc.config;
...
public class MybatisPlusConfiguration {
	...
	/**
	 * mybatis-plus分页插件 文档：http://mp.baomidou.com<br>
	 */
	@Bean
	public PaginationInterceptor paginationInterceptor() {
		 ...
		 *//*
			 ...
			 *//*
				 ...
				 * paginationInterceptor.setSqlParserFilter(new
				 * ISqlParserFilter() {
				 * 
				 * @Override public boolean doFilter(MetaObject metaObject) {
				 * MappedStatement ms =
				 * PluginUtils.getMappedStatement(metaObject); //
				 * 过滤自定义查询此时无租户信息约束【 麻花藤 】出现 if
				 * ("com.baomidou.springboot.mapper.UserMapper.selectListBySQL".
